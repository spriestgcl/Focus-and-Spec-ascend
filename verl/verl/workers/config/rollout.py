...
class RolloutConfig(BaseConfig):
    ...
    redundant_inference_enabled: bool = False
    redundancy_p: float = 0.0
    redundant_partial_prompt_accept_ratio: float = 1.0
    redundant_short_rounds_per_cycle: int = 4
    redundant_flush_tail_at_epoch_end: bool = True
