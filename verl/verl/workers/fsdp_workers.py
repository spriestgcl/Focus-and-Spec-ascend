    ...
    def _build_model_optimizer(
        ...
        if self._is_lora:
            ...
            if lora_adapter_path is not None:
                ...
                # peft may try casting adapters to newer float8 dtypes that are
                # unavailable in this torch-npu stack.
                actor_module = get_peft_model(
                    actor_module, LoraConfig(**lora_config), autocast_adapter_dtype=False
                )
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        if self._is_lora:
            ...
            if lora_adapter_path is not None:
                ...
                # Keep LoRA adapter dtype unchanged for older torch builds.
                critic_module = get_peft_model(
                    critic_module, LoraConfig(**lora_config), autocast_adapter_dtype=False
                )
