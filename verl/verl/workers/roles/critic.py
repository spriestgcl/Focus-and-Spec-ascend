...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def update_critic(self, data: DataProto):
        ...
        effective_mini_batch_size = self.ppo_mini_batch_size_per_dp
        local_batch_size = len(data)
        if local_batch_size > 0 and local_batch_size % effective_mini_batch_size != 0:
            effective_mini_batch_size = local_batch_size
