...
template <class ArchTag_, class ComputeType_, class TileShape_> struct TileRowBroadcastMul {
...
/// @tparam ComputeType_ includes the element type and layout information.
/// @tparam TileShape_ is the shape (m, n).
template <class ArchTag_, class ComputeType_, class TileShape_> struct TileOneBlkColumnBroadcastMul {
    using ArchTag = ArchTag_;
    using ElementCompute = typename ComputeType_::Element;
    using TileShape = TileShape_;
