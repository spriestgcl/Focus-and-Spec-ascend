...
template <class ArchTag, class GmType> struct MatrixCopyGmToUB {
...
/// Matrix A confirm
template <class Element> struct MatrixCopyGmToUB<Arch::AtlasA2, Gemm::GemmType<Element, layout::RowMajor>> {
...
/// Matrix A confirm
template <class Element> struct MatrixCopyGmToUB<Arch::AtlasA2, Gemm::GemmType<Element, layout::ColumnMajor>> {
