...
public:
    ...
    template <class Element> CATLASS_HOST_DEVICE static RowMajor MakeLayoutInUb(MatrixCoord const &shape)
    {
...
public:
    ...
    template <class Element> CATLASS_HOST_DEVICE constexpr static nZ MakeLayout(Index orgRows, Index orgCols)
    {
...
public:
    ...
    /// Make the layout of a coordinate (row, column)
    template <class Element> CATLASS_HOST_DEVICE constexpr static zN MakeLayout(Index orgRows, Index orgCols)
    {
        constexpr uint32_t ELE_NUM_PER_C0 = BYTE_PER_C0 / sizeof(Element);
        constexpr uint32_t ELE_NUM_PER_FRACTAL = BYTE_PER_FRACTAL / sizeof(Element);
...
public:
    ...
    /// Make the layout of a coordinate (row, column)
    template <class Element> CATLASS_HOST_DEVICE constexpr static zZ MakeLayout(Index orgRows, Index orgCols)
    {
        constexpr uint32_t ELE_NUM_PER_C0 = BYTE_PER_C0 / sizeof(Element);
        constexpr uint32_t ELE_NUM_PER_FRACTAL = BYTE_PER_FRACTAL / sizeof(Element);
        Index rowsRound = RoundUp<C0_NUM_PER_FRACTAL>(orgRows);
...
public:
    ...
    /// Make the layout of a coordinate (row, column)
    template <class Element> CATLASS_HOST_DEVICE static nN MakeLayout(Index orgRows, Index orgCols)
    {
        static constexpr uint32_t ELE_NUM_PER_C0 = BYTE_PER_C0 / sizeof(Element);
        static constexpr uint32_t ELE_NUM_PER_FRACTAL = BYTE_PER_FRACTAL / sizeof(Element);
        Index rowsRound = RoundUp<ELE_NUM_PER_C0>(orgRows);
        Index colsRound = RoundUp<C0_NUM_PER_FRACTAL>(orgCols);
        return nN(orgRows, orgCols, ELE_NUM_PER_C0, rowsRound / ELE_NUM_PER_C0, C0_NUM_PER_FRACTAL,
                  colsRound / C0_NUM_PER_FRACTAL, 1, ELE_NUM_PER_FRACTAL, ELE_NUM_PER_C0,
