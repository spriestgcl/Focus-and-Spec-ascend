...
def _build_args(x_in__, weight_in__, weight_scale_in__, x_scale_in__, group_list_in__, y_out_, y_scale_out_):
    __inputs__ = []
...
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.DYNAMIC_INPUT, para_check.DYNAMIC_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.KERNEL_NAME)
def grouped_matmul_swiglu_quant_weight_nz_tensor_list(x_in__, weight_in__, weight_scale_in__, x_scale_in__, group_list_in__, y_out_, y_scale_out_, kernel_name="grouped_matmul_swiglu_quant_weight_nz_tensor_list", impl_mode = ""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_in__, weight_scale_in__, x_scale_in__, group_list_in__, y_out_, y_scale_out_)
...
def op_select_format(x_in__, weight_in__, weight_scale_in__, x_scale_in__, group_list_in__, y_out_, y_scale_out_, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_in__, weight_scale_in__, x_scale_in__, group_list_in__, y_out_, y_scale_out_)
    result = check_op_cap("op_select_format", "GroupedMatmulSwigluQuantWeightNzTensorList", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, weight_in__, weight_scale_in__, x_scale_in__, group_list_in__, y_out_, y_scale_out_, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_in__, weight_scale_in__, x_scale_in__, group_list_in__, y_out_, y_scale_out_)
